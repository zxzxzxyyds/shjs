...
local UITab5 = win:Tab("『cdt刷钱』",'7734068321')
...
local UITab6 = win:Tab("『cdt奖杯』",'7734068321')

local about = UITab6:section("『cdt奖杯』",true)

about:Button("cdt奖杯",function()
...
local UITab9 = win:Tab("『dw』",'7734068321')

local about = UITab9:section("『dw』",true)

about:Button("dw",function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/x3fall3nangel/FallAngelHub/main/DriveWorld.lua"))() 
end)

local UITab10 = win:Tab("『唐县卡车』",'7734068321')

local about = UITab10:section("『唐县卡车』",true)
...
local UITab12 = win:Tab("『皮脚本』",'7734068321')

local about = UITab12:section("『皮脚本』",true)
